...
if("TRUE" STREQUAL "TRUE")
  set(ArmControl_SOURCE_PREFIX /home/aj/RobotArm/src/ArmControl)
  set(ArmControl_DEVEL_PREFIX /home/aj/RobotArm/devel)
  ...
  set(ArmControl_INSTALL_PREFIX /home/aj/RobotArm/install)
...
if(NOT "/home/aj/RobotArm/devel/include " STREQUAL " ")
  set(ArmControl_INCLUDE_DIRS "")
  set(_include_dirs "/home/aj/RobotArm/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ArmControl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aj/RobotArm/src/ArmControl/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ArmControl_NUM_DUMMY_TARGETS)
      set(ArmControl_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ArmControl::wrapped-linker-option${ArmControl_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ArmControl_NUM_DUMMY_TARGETS "${ArmControl_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ArmControl::wrapped-linker-option${ArmControl_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ArmControl_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aj/RobotArm/devel/lib;/opt/ros/noetic/lib)
...
set(ArmControl_EXPORTED_TARGETS "ArmControl_generate_messages_cpp;ArmControl_generate_messages_eus;ArmControl_generate_messages_lisp;ArmControl_generate_messages_nodejs;ArmControl_generate_messages_py")
...
set(depends "roscpp;rospy;rosserial_arduino;rosserial_python;std_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ArmControl_EXPORTED_TARGETS ${${ArmControl_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "ArmControl-msg-extras.cmake")
